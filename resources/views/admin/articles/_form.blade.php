<div class="general_parameters">
	...
	<div class="one_select mdl-cell mdl-cell--6-col">
		...
		{!! Form::select('type_id', \App\Http\Help::createOptions($types, 'type_id', 'type_title'), $activeType, ['class' =>'form-control', 'id' => 'type_select']) !!}
	</div>
	<div class="one_select mdl-cell mdl-cell--6-col js_project_input project_input">
		...
		{!! Form::select('project_id', \App\Http\Help::createOptions($projects, 'project_id', 'title_ua'), null, ['class' =>'form-control js_input', 'disabled']) !!}
	</div>
	...
	<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label date {{ $errors->has('published_at') ? 'is-invalid' : '' }}">
		...
		{!! Form::text('published_at', \Carbon\Carbon::now()->format('d.m.Y H:i'), ['id' => 'published_at', 'class' => 'mdl-textfield__input datepicker-here select', 'data-timepicker' => 'true']) !!}
	...
	<div class="file_block">
		{!! Form::label('image', 'Выбирете миниатюру статьи', ['class' => 'file_uploader--label']) !!}
