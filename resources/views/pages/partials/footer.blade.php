	...
	<div class="container">
		<div class="row">
			<footer>
				...
				<div class="donate col-lg-3 col-lg-offset-1 col-md-3 col-md-offset-1 col-sm-12 col-sm-offset-0">
				...
				<div class="subscribe col-lg-4 col-md-4 col-md-offset-1 col-sm-12 col-sm-offset-0" >
				...
				<div class="copy col-lg-12 col-md-12 col-sm-12">
